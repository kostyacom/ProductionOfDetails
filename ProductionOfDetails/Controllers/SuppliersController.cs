...
namespace ProductionOfDetails.Controllers
{
    ...
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(Production_of_detalsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var suppliers = await _context.Suppliers
                .SingleOrDefaultAsync(m => m.IdSupplier == id);
            if (suppliers == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var suppliers = await _context.Suppliers.SingleOrDefaultAsync(m => m.IdSupplier == id);
            if (suppliers == null)
            {
                return NotFound();
            }
